    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      ...
      <el-tab-pane label="今日" name="today">
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="agentTime" label="推荐人" align="center"></el-table-column>
          <el-table-column prop="referrer" label="运营商级别" align="center"></el-table-column>
          <el-table-column prop="OperatorTime" label="加入运营商时间" align="center"></el-table-column>
          <el-table-column prop="geagentLevelnder" label="到期时间" align="center"></el-table-column>
      ...
      tableData: [
        {
          ...
          OperatorTime: "2020-03-09",
          geagentLevelnder: "2020-09-03",
          state: "1",
          purchaseOrder: "0",
          balance: "0.00",
